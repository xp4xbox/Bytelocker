...
This program is a Windows ransomeware similar to cryptolocker which uses AES-256 with a local password. This program was created for educational purposes. There is **no built-in payment system**.
